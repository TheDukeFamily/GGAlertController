...
@interface GGAlertAction()
@property (nullable, nonatomic) NSString *title;
@property (nonatomic, assign) GGAlertActionStyle style;
@property (nonatomic, copy) void (^handler)(GGAlertAction *action);
@property (nonatomic, copy) void (^propertyEvent)(GGAlertAction *action);
@end

@implementation GGAlertAction

- (id)copyWithZone:(NSZone *)zone{
    GGAlertAction *action = [[[self class] alloc] init];
...
+ (instancetype)actionWithTitle:(nullable NSString *)title style:(GGAlertActionStyle)style handler:(void (^ __nullable)(GGAlertAction *action))handler {
    GGAlertAction *action = [[self alloc] initWithTitle:title style:(GGAlertActionStyle)style handler:handler];
    return action;
}

- (instancetype)initWithTitle:title style:(GGAlertActionStyle)style handler:(void(^ __nullable)(GGAlertAction *action))Handler{
    if (self = [super init]) {
        self.title = title;
        self.style = style;
        self.enabled = YES;
        self.handler = Handler;
        if (style == GGAlertActionStyleDestructive) {
            self.titleColor = [UIColor redColor];
        }else if (style == GGAlertActionStyleCancel){
...
#pragma mark - GGAlertAction END

#pragma mark - GGAlertControllerActionCell Begin

@interface GGAlertControllerActionCell:UITableViewCell
@property (nonatomic , strong)GGAlertAction *action;
...
@implementation GGAlertControllerActionCell
...
- (void)setAction:(GGAlertAction *)action{
    _action = action;
...
#pragma mark ---------------------------- GGAlertControllerActionCell end --------------------------------


#pragma mark ---------------------------- GGAlertController begin --------------------------------


@interface GGAlertController () <UIViewControllerTransitioningDelegate,UITableViewDataSource,UITableViewDelegate>
...
// action数组
@property (nonatomic) NSArray<GGAlertAction *> *actions;
// 取消样式的action数组
...
@property (nonatomic, assign) GGAlertControllerStyle preferredStyle;
@property (nonatomic, assign) GGAlertAnimationType animationType;
// 底部的cell数组
...
@property (nonatomic, assign) GGBackgroundViewAppearanceStyle backgroundViewAppearanceStyle;
@property (nonatomic, assign) CGFloat backgroundViewAlpha;
@end

@implementation GGAlertController
...
+(instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message preferredStyle:(GGAlertControllerStyle)preferredStyle animationType:(GGAlertAnimationType)animationType{
    GGAlertController *alertController = [self alertControllerWithTitle:title message:message preferredStyle:preferredStyle animationType:animationType customView:nil];
    return alertController;
}

+ (instancetype)alertControllerWithTitle:(nullable NSString *)title message:(nullable NSString *)message preferredStyle:(GGAlertControllerStyle)preferredStyle animationType:(GGAlertAnimationType)animationType customView:(UIView *)customView {
    // 创建控制器
    GGAlertController *alertController = [[GGAlertController alloc] initWithTitle:title message:message preferredStyle:preferredStyle animationType:animationType customView:customView customHeaderView:nil customCenterView:nil customFooterView:nil];
    return alertController;
}

+ (instancetype)alertControllerWithPreferredStyle:(GGAlertControllerStyle)preferredStyle animationType:(GGAlertAnimationType)animationType customHeaderView:(nullable UIView *)customHeaderView {
    // 创建控制器
    GGAlertController *alertController = [[GGAlertController alloc] initWithTitle:nil message:nil preferredStyle:preferredStyle animationType:animationType customView:nil customHeaderView:customHeaderView customCenterView:nil customFooterView:nil];
    return alertController;
}

+ (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message preferredStyle:(GGAlertControllerStyle)preferredStyle animationType:(GGAlertAnimationType)animationType customCenterView:(UIView *)customCenterView {
    // 创建控制器
    GGAlertController *alertController = [[GGAlertController alloc] initWithTitle:title message:message preferredStyle:preferredStyle animationType:animationType customView:nil customHeaderView:nil customCenterView:customCenterView customFooterView:nil];
    return alertController;
}

+ (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message preferredStyle:(GGAlertControllerStyle)preferredStyle animationType:(GGAlertAnimationType)animationType customFooterView:(UIView *)customFooterView {
    // 创建控制器
    GGAlertController *alertController = [[GGAlertController alloc] initWithTitle:title message:message preferredStyle:preferredStyle animationType:animationType customView:nil customHeaderView:nil customCenterView:nil customFooterView:customFooterView];
    return alertController;
}

// 添加action
- (void)addAction:(GGAlertAction *)action {
    ...
    if (self.cancelActions.count && self.preferredStyle == GGAlertControllerStyleActionSheet) {
        if (action.style == GGAlertActionStyleCancel) { // 取消样式的按钮顺序排列
    ...
    if (self.preferredStyle == GGAlertControllerStyleActionSheet) {
        if (self.customCenterView && action.style != GGAlertActionStyleCancel) {
        ...
        if (action.style == GGAlertActionStyleCancel && !self.customFooterView) {
    ...
    action.propertyEvent = ^(GGAlertAction *action) {
        if (weakSelf.preferredStyle == GGAlertControllerStyleActionSheet) {
            if (action.style == GGAlertActionStyleCancel) {
                NSInteger index = [weakSelf.cancelActions indexOfObject:action];
                // 注意这个cell是与tableView没有任何瓜葛的
                GGAlertControllerActionCell *footerCell = [weakSelf.footerCells objectAtIndex:index];
            ...
            if (weakSelf.actions.count <= maxNumberOfActionHorizontalArrangementForAlert) {
                ...
                GGAlertControllerActionCell *footerCell = weakSelf.footerCells[index];
                footerCell.action = action;
            } else {
                [weakSelf.actionTableView reloadData];
            }
...
- (void)addTextFieldWithConfigurationHandler:(void (^)(UITextField * _Nonnull))configurationHandler {
    ...
    NSAssert(self.preferredStyle == GGAlertControllerStyleAlert, @"SPAlertControllerStyleActionSheet样式拒绝添加文本输入框");
...
- (void)setBackgroundViewAppearanceStyle:(GGBackgroundViewAppearanceStyle)style alpha:(CGFloat)alpha {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    GGAlertControllerActionCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([GGAlertControllerActionCell class]) forIndexPath:indexPath];
    GGAlertAction *action = self.dataSource[indexPath.row];
    cell.action = action;
    return cell;
}
...
#pragma mark - Private
- (instancetype)initWithTitle:(nullable NSString *)title message:(nullable NSString *)message preferredStyle:(GGAlertControllerStyle)preferredStyle animationType:(GGAlertAnimationType)animationType customView:(UIView *)customView customHeaderView:(UIView *)customHeaderView customCenterView:(UIView *)customCenterView customFooterView:(UIView *)customFooterView{
    if (self = [super init]) {
    self.providesPresentationContextTransitionStyle = YES;
        ...
        if (animationType == GGAlertAnimationTypeDefault) {
            if (self.preferredStyle == GGAlertControllerStyleAlert) {
                animationType= GGAlertAnimationTypeAlpha;
            } else if (self.preferredStyle == GGAlertControllerStyleActionSheet) {
                animationType = GGAlertAnimationTypeRaiseUp;
            } else {
                animationType = GGAlertAnimationTypeRaiseUp;
            }
        }
...
- (void)setupViewsAboutAction:(UIView *)customCenterView {
    ...
    if (!customCenterView) {
        ...
        [actionTableView registerClass:[GGAlertControllerActionCell class] forCellReuseIdentifier:NSStringFromClass([GGAlertControllerActionCell class])];
...
- (void)createFooterCellWithAction:(GGAlertAction *)action {
    ...
    GGAlertControllerActionCell *footerCell = [[GGAlertControllerActionCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:FOOTERCELL];
...
- (void)clickedFooterCell:(UIButton *)sender {
    ...
    if (self.preferredStyle == GGAlertControllerStyleActionSheet) {
        GGAlertControllerActionCell *footerCell = (GGAlertControllerActionCell *)sender.superview;
        NSInteger index = [self.footerCells indexOfObject:footerCell];
        GGAlertAction *action = [self.cancelActions objectAtIndex:index];
        // 回调action的block
        if (action.handler) {
            action.handler(action);
        }
        ...
        if (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) {
            GGAlertControllerActionCell *footerCell = (GGAlertControllerActionCell *)sender.superview;
            NSInteger index = [self.footerCells indexOfObject:footerCell];
            GGAlertAction *action = [self.actions objectAtIndex:index];
            // 回调action的block
            if (action.handler) {
                action.handler(action);
            }
...
- (void)layoutFooter {
    ...
    if ((self.preferredStyle == GGAlertControllerStyleActionSheet && self.cancelActions.count) || (self.preferredStyle == GGAlertControllerStyleAlert && (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) && self.actions.count)) { // 需要footerBezelView
        if (self.preferredStyle == GGAlertControllerStyleAlert) { // alert样式
    ...
    if (!self.customFooterView) { // 不是自定义的footerView
        ...
        if (footerCells.count && ((self.preferredStyle == GGAlertControllerStyleActionSheet && self.cancelActions.count) || (self.preferredStyle == GGAlertControllerStyleAlert && self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert))) {
            [footerCells enumerateObjectsUsingBlock:^(GGAlertControllerActionCell *footerCell, NSUInteger idx, BOOL * _Nonnull stop) {
                if (self.preferredStyle == GGAlertControllerStyleAlert) {
                    // 设置footerCell的上下间距
...
- (CGFloat)actionBezelHeight:(CGFloat)footerTopMargin {
    ...
    if (self.actions.count) {
        ...
        } else if (self.preferredStyle == GGAlertControllerStyleAlert) {
            if (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) {
...
- (void)setOffsetYForAlert:(CGFloat)offsetYForAlert {
    ...
    GGAlertPresentationController *presentationVc = (GGAlertPresentationController *)self.presentationController;
...
- (nullable id <UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented presentingController:(UIViewController *)presenting sourceController:(UIViewController *)source {
    return [GGAlertAnimation animationIsPresenting:YES];
}

- (nullable id <UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed {
    [self.view endEditing:YES];
    return [GGAlertAnimation animationIsPresenting:NO];
}

- (nullable UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(nullable UIViewController *)presenting sourceViewController:(UIViewController *)source NS_AVAILABLE_IOS(8_0) {
    return [[GGAlertPresentationController alloc] initWithPresentedViewController:presented presentingViewController:presenting];
}
...
@property (nonatomic, assign) GGAlertController *alertController;
@property (nonatomic, strong) UIVisualEffectView *effectView;
@property (nonatomic, assign) CGFloat cornerRadiusForAlert;
- (void)redrawWithView:(UIView *)view alertController:(GGAlertController *)alertController;
@end
...
- (void)setAppearanceStyle:(GGBackgroundViewAppearanceStyle)appearanceStyle alpha:(CGFloat)alpha {
    switch (appearanceStyle) {
        case GGBackgroundViewAppearanceStyleTranslucent: {
            ...
            break;
        case GGBackgroundViewAppearanceStyleBlurExtraLight: {
            UIBlurEffect *blur = [UIBlurEffect effectWithStyle:UIBlurEffectStyleExtraLight];
            [self createVisualEffectViewWithBlur:blur alpha:alpha];
        }
            break;
        case GGBackgroundViewAppearanceStyleBlurLight: {
            UIBlurEffect *blur = [UIBlurEffect effectWithStyle:UIBlurEffectStyleLight];
            [self createVisualEffectViewWithBlur:blur alpha:alpha];
        }
            break;
        case GGBackgroundViewAppearanceStyleBlurDark: {
...
- (void)drawRect:(CGRect)rect {
    [super drawRect:rect];
    // 黑色带透明时进行镂空
    if (self.alertController.backgroundViewAppearanceStyle == GGBackgroundViewAppearanceStyleTranslucent && self.alertController.needDialogBlur && !self.alertController.textFields.count) {
        _cornerRadiusForAlert = (self.alertController.preferredStyle==GGAlertControllerStyleActionSheet)? 0 : self.alertController.cornerRadiusForAlert;
...
@interface GGAlertPresentationController()
@property (nonatomic, weak) GGOverlayView *overlayView;
@property (nonatomic, strong) NSMutableArray *presentedViewConstraints;
@end

@implementation GGAlertPresentationController
...
- (void)didChangeStatusBarOrientation:(NSNotification *)notification {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.3 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        GGAlertController *alertController = (GGAlertController *)self.presentedViewController;
        CGFloat cornerRadius = 0;
        if (alertController.preferredStyle == GGAlertControllerStyleAlert) {
...
- (void)presentationTransitionWillBegin {
    ...
    GGOverlayView *overlayView = [[GGOverlayView alloc] init];
...
- (void)updateConstraints {
    ...
    if (!customView) { // 非自定义
        if (alertController.preferredStyle == GGAlertControllerStyleActionSheet) {
            ...
            if (alertController.animationType == GGAlertAnimationTypeDropDown) {
        ...
        } else if (alertController.preferredStyle == GGAlertControllerStyleAlert) {
...
@interface GGAlertAnimation()
@property (nonatomic, assign) BOOL presenting;
@property (nonatomic, assign) CGFloat delayTime;
@end

@implementation GGAlertAnimation
...
- (void)presentAnimationTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    GGAlertController *alertController = (GGAlertController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    CGSize controlViewSize = alertController.view.bounds.size;
    
    // 获取presentationController，注意不是presentedController
    GGAlertPresentationController *presentedController = (GGAlertPresentationController *)alertController.presentationController;
    GGOverlayView *overlayView = presentedController.overlayView;
    
    switch (alertController.animationType) {
        case GGAlertAnimationTypeRaiseUp:
            [self raiseUpWhenPresentForController:alertController
                                       transition:transitionContext
                                  controlViewSize:controlViewSize
                                      overlayView:overlayView];
            break;
        case GGAlertAnimationTypeDropDown:
...
- (void)dismissAnimationTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    GGAlertController *alertController = (GGAlertController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    CGSize controlViewSize = alertController.view.bounds.size;
    // 获取presentationController，注意不是presentedController
    GGAlertPresentationController *presentedController = (GGAlertPresentationController *)alertController.presentationController;
    GGOverlayView *overlayView = presentedController.overlayView;
...
// 从底部忘上弹的present动画
- (void)raiseUpWhenPresentForController:(GGAlertController *)alertController
                             transition:(id<UIViewControllerContextTransitioning>)transitionContext
                        controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
...
// 从底部往上弹对应的dismiss动画
- (void)dismissCorrespondingRaiseUpForController:(GGAlertController *)alertController
                                      transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                 controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
...
// 从顶部往下弹的present动画
- (void)dropDownWhenPresentForController:(GGAlertController *)alertController
                              transition:(id<UIViewControllerContextTransitioning>)transitionContext
                         controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
...
// 从顶部往下弹对应的dismiss动画
- (void)dismissCorrespondingDropDownForController:(GGAlertController *)alertController
                                       transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                  controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
    [overlayView redrawWithView:nil alertController:nil];
...
- (void)alphaWhenPresentForController:(GGAlertController *)alertController
                           transition:(id<UIViewControllerContextTransitioning>)transitionContext
                      controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
...
- (void)dismissCorrespondingAlphaForController:(GGAlertController *)alertController
                                    transition:(id<UIViewControllerContextTransitioning>)transitionContext
                               controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
    [overlayView redrawWithView:nil alertController:nil];
...
// 发散的prensent动画
- (void)expandWhenPresentForController:(GGAlertController *)alertController
                            transition:(id<UIViewControllerContextTransitioning>)transitionContext
                       controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
...
// 发散对应的dismiss动画
- (void)dismissCorrespondingExpandForController:(GGAlertController *)alertController
                                     transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
    [overlayView redrawWithView:nil alertController:nil];
...
// 收缩的present动画
- (void)shrinkWhenPresentForController:(GGAlertController *)alertController
                            transition:(id<UIViewControllerContextTransitioning>)transitionContext
                       controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
...
// 收缩对应的的dismiss动画
- (void)dismissCorrespondingShrinkForController:(GGAlertController *)alertController
                                     transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                controlViewSize:(CGSize)controlViewSize overlayView:(GGOverlayView *)overlayView {
    // 与发散对应的dismiss动画相同
